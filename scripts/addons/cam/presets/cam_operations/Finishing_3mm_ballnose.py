...
o.feedrate = 1.0
o.filename = o.name = (
    f"OP_{o.object_name}_{scene.cam_active_operation + 1}_{Path(__file__).stem}"
)
...
o.parallel_angle = 0.7853984832763672
o.pixsize = 9.999999747378752e-05
o.plunge_feedrate = 50.0
o.protect_vertical = False
o.render_all = True
o.skin = 0.0
