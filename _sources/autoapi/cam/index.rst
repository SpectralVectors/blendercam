...
.. py:class:: camOperation
   ...
   .. py:attribute:: straight
      :type:  BoolProperty(name='Overshoot Style', description='Use overshoot cutout instead of conventional rounded', default=False, update=updateRest)
...
.. py:class:: CamCurveHatch
   ...
   .. py:attribute:: height
      :type:  FloatProperty(default=0.0, min=-1.0, max=1.0, precision=4, unit='LENGTH')


   .. py:attribute:: amount
      :type:  IntProperty(default=10, min=1, max=10000)


   .. py:attribute:: hull
      :type:  BoolProperty(default=False)
   ...
   .. py:attribute:: pocket_type
      :type:  EnumProperty(name='Type Pocket', items=(('BOUNDS', 'Makes a bounds rectangle', 'Makes a bounding square'), ('POCKET', 'Pocket', 'Makes a pocket inside a closed loop')), description='Type of pocket', default='POCKET')
   ...
   .. py:method:: draw(context)
      ...
      :param context: The context in which the layout is drawn, typically
...
.. py:class:: CamCurveRemoveDoubles
   ...
   .. py:attribute:: merg_distance
      :type:  FloatProperty(name='Merge distance', default=0.0001, min=0.0, max=0.01)
...
.. py:class:: CamOffsetSilhouete
   ...
   .. py:attribute:: style
      :type:  EnumProperty(name='Type of Curve', items=(('1', 'Round', ''), ('2', 'Mitre', ''), ('3', 'Bevel', '')))


   .. py:attribute:: opencurve
      :type:  BoolProperty(name='Dialate Open Curve', default=False)
