...
.. py:module:: cam.operators.curve_tools_ops
...
.. autoapisummary::
   ...
   cam.operators.curve_tools_ops.CamCurveBoolean
   cam.operators.curve_tools_ops.CamCurveConvexHull
   cam.operators.curve_tools_ops.CamCurveIntarsion
   cam.operators.curve_tools_ops.CamCurveOvercuts
   cam.operators.curve_tools_ops.CamCurveOvercutsB
   cam.operators.curve_tools_ops.CamCurveRemoveDoubles
   cam.operators.curve_tools_ops.CamMeshGetPockets
   cam.operators.curve_tools_ops.CamOffsetSilhouete
   cam.operators.curve_tools_ops.CamObjectSilhouette
