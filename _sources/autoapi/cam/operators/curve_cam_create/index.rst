cam.operators.curve_cam_create
==============================

.. py:module:: cam.operators.curve_cam_create
...
.. autoapisummary::
   ...
   cam.operators.curve_cam_create.CamCurveHatch
   cam.operators.curve_cam_create.CamCurvePlate
   cam.operators.curve_cam_create.CamCurveFlatCone
   cam.operators.curve_cam_create.CamCurveMortise
   cam.operators.curve_cam_create.CamCurveInterlock
   cam.operators.curve_cam_create.CamCurveDrawer
   cam.operators.curve_cam_create.CamCurvePuzzle
   cam.operators.curve_cam_create.CamCurveGear
...
.. autoapisummary::
   ...
   cam.operators.curve_cam_create.generate_crosshatch
