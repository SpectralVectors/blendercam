...
.. toctree::
   ...
   /autoapi/cam/operators/async_op/index
   /autoapi/cam/operators/bas_relief_ops/index
   /autoapi/cam/operators/bridges_op/index
   /autoapi/cam/operators/chain_ops/index
   /autoapi/cam/operators/curve_create_ops/index
   /autoapi/cam/operators/curve_equation_ops/index
   /autoapi/cam/operators/curve_tools_ops/index
   /autoapi/cam/operators/gcode_import_op/index
   /autoapi/cam/operators/operation_ops/index
   /autoapi/cam/operators/orient_op/index
   /autoapi/cam/operators/pack_op/index
   /autoapi/cam/operators/path_ops/index
   /autoapi/cam/operators/position_op/index
   /autoapi/cam/operators/preset_ops/index
   /autoapi/cam/operators/simulation_ops/index
   /autoapi/cam/operators/slice_op/index
...
.. autoapisummary::
   ...
   cam.operators.DoBasRelief
   cam.operators.ProblemAreas
   cam.operators.CamBridgesAdd
   cam.operators.CamChainAdd
   cam.operators.CamChainOperationAdd
   cam.operators.CamChainOperationDown
   cam.operators.CamChainOperationRemove
   cam.operators.CamChainOperationUp
   cam.operators.CamChainRemove
   cam.operators.CamCurveDrawer
   cam.operators.CamCurveFlatCone
   cam.operators.CamCurveGear
   cam.operators.CamCurveHatch
   cam.operators.CamCurveInterlock
   cam.operators.CamCurveMortise
   cam.operators.CamCurvePlate
   cam.operators.CamCurvePuzzle
   cam.operators.CamCustomCurve
   cam.operators.CamHypotrochoidCurve
   cam.operators.CamLissajousCurve
   cam.operators.CamSineCurve
   cam.operators.CamCurveBoolean
   cam.operators.CamCurveConvexHull
   cam.operators.CamCurveIntarsion
   cam.operators.CamCurveOvercuts
   cam.operators.CamCurveOvercutsB
   cam.operators.CamCurveRemoveDoubles
   cam.operators.CamMeshGetPockets
   cam.operators.CamObjectSilhouette
   cam.operators.CamOffsetSilhouete
   cam.operators.WM_OT_gcode_import
   cam.operators.CamOperationAdd
   cam.operators.CamOperationCopy
   cam.operators.CamOperationMove
   cam.operators.CamOperationRemove
   cam.operators.CamOrientationAdd
   cam.operators.CamPackObjects
   cam.operators.PathExport
   cam.operators.PathExportChain
   cam.operators.PathsAll
   cam.operators.PathsBackground
   cam.operators.PathsChain
   cam.operators.KillPathsBackground
   cam.operators.CalculatePath
   cam.operators.CAM_MATERIAL_PositionObject
   cam.operators.AddPresetCamCutter
   cam.operators.AddPresetCamMachine
   cam.operators.AddPresetCamOperation
   cam.operators.CAMSimulate
   cam.operators.CAMSimulateChain
   cam.operators.CamSliceObjects
...
.. autoapisummary::
   ...
   cam.operators.register
   cam.operators.unregister
