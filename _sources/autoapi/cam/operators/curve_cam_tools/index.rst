cam.operators.curve_cam_tools
=============================

.. py:module:: cam.operators.curve_cam_tools
...
.. autoapisummary::
   ...
   cam.operators.curve_cam_tools.CamCurveBoolean
   cam.operators.curve_cam_tools.CamCurveConvexHull
   cam.operators.curve_cam_tools.CamCurveIntarsion
   cam.operators.curve_cam_tools.CamCurveOvercuts
   cam.operators.curve_cam_tools.CamCurveOvercutsB
   cam.operators.curve_cam_tools.CamCurveRemoveDoubles
   cam.operators.curve_cam_tools.CamMeshGetPockets
   cam.operators.curve_cam_tools.CamOffsetSilhouete
   cam.operators.curve_cam_tools.CamObjectSilhouette
