...
.. autoapisummary::
   ...
   cam.operators.ops.threadCom
   cam.operators.ops.PathsBackground
   cam.operators.ops.KillPathsBackground
   cam.operators.ops.CalculatePath
   cam.operators.ops.PathsAll
   cam.operators.ops.CamPackObjects
   cam.operators.ops.CamSliceObjects
   cam.operators.ops.PathsChain
   cam.operators.ops.PathExportChain
   cam.operators.ops.PathExport
   cam.operators.ops.CAMSimulate
   cam.operators.ops.CAMSimulateChain
   cam.operators.ops.CamChainAdd
   cam.operators.ops.CamChainRemove
   cam.operators.ops.CamChainOperationAdd
   cam.operators.ops.CamChainOperationUp
   cam.operators.ops.CamChainOperationDown
   cam.operators.ops.CamChainOperationRemove
   cam.operators.ops.CamOperationAdd
   cam.operators.ops.CamOperationCopy
   cam.operators.ops.CamOperationRemove
   cam.operators.ops.CamOperationMove
   cam.operators.ops.CamOrientationAdd
   cam.operators.ops.CamBridgesAdd
...
.. autoapisummary::
   ...
   cam.operators.ops.thread_read
   cam.operators.ops.timer_update
   cam.operators.ops._calc_path
   cam.operators.ops.get_chain_operations
   cam.operators.ops.fix_units
